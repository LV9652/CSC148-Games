...
def friendGUI():
    ...
    l_pic = Label(friend_win, image=img)
    l_pic.grid(row=1, column=2)

    l_turn = Label(f2,text="Black, your turn!",width=20)
    l_turn.grid(row=2, column=2,pady=10)


    button_undo = Button(f2,text="Undo",width=4,command=button_undo)
    button_undo.grid(row=3, column=2,pady=10)



    button_new = Button(f2,text="New",width=4,command=button_new)
    button_new.grid(row=4, column=2,pady=10)
